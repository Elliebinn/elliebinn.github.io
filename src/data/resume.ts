...
type PlatformProfile = {
  ...
  careers: {
    company: string;
    meta: string; // "AI포트폴리오본부 | 2025.04 ~ 현재"
...
export const resume: ResumeData = {
  ...
  remember: {
    intro: [
      ...
      '에셋플러스자산운용에서 AI 공모펀드 4종의 일일 운용을 직접 수행하며 RATB 심사, ETF 투자유니버스 설계, 금융상품 기획을 담당했고(자회사 알파브릿지 겸임·상주), 2025년 4월부터 알파브릿지 AI포트폴리오본부에서 그 도메인 지식을 제품 기획과 직접 구현으로 연결하고 있습니다. 직접 운용하며 쌓은 도메인 지식으로 일일 운용시간 83% 단축, 38개 AI 전략 전원 심사 통과 등의 성과를 만들었습니다.',
    ...
    careers: [
      {
        company: '알파브릿지주식회사',
        meta: 'AI포트폴리오본부 | 2025.04 ~ 현재 재직 중',
        blocks: [
          {
            title: 'AI 투자 전략 자산화 시스템 기획',
            period: '2026.07 ~ 현재',
  ...
  wanted: {
    ...
    careers: [
      {
        company: '알파브릿지주식회사',
        meta: '정규직 | 직무: 서비스기획 | 직책: 사원 | AI포트폴리오본부 | 2025.04 ~ 재직 중',
        blocks: [
          {
            title: 'AI 투자 전략 자산화 시스템 기획',
            period: '2026.07 ~ 현재',
    ...
    extraSections: [
      {
        ...
        label: 'AI 활용 경험',
        maxPerBullet: 50,
        // 겹치는 각도를 빼고 5개만 남긴다. 구현 규모 / 검증 / 사용자 성과 /
        // 에이전트 설계 / AI 판단의 사후 검증 — 서로 다른 역량을 하나씩 증명한다.
        bullets: [
          'Claude Code로 약 500개 전략 분석 화면 직접 구현 (프론트 0명)',
          'AI 도구로 지표 산식 전수조사해 10개 핵심 지표 표준화',
          '정보구조 재설계로 리서처 분석 활용시간 2배 증가',
          '주주곰 — 6개 전문 에이전트·4인 토론 파이프라인 1인 설계',
          'AI가 자동 조합한 전략의 변경 이력으로 사후 검증 설계',
        ],
      },
    ],
    skills: [
