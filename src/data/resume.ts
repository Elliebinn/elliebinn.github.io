...
type PlatformProfile = {
  ...
  extraSections?: {
    label: string;
    /** 항목 하나당 글자수 상한 (원티드 AI 활용 경험 = 50자). 생성기가 검사한다 */
    maxPerBullet?: number;
    bullets: string[];
  }[];
  skills: string[];
...
export const resume: ResumeData = {
  ...
  remember: {
    intro: [
      ...
      '에셋플러스자산운용에서 AI 공모펀드 4종의 일일 운용을 직접 수행하며 RATB 심사, ETF 투자유니버스 설계, 금융상품 기획을 담당했고(자회사 알파브릿지 겸임·상주), 2025년 4월부터 알파브릿지 포트폴리오본부에서 그 도메인 지식을 제품 기획과 직접 구현으로 연결하고 있습니다. 직접 운용하며 쌓은 도메인 지식으로 일일 운용시간 83% 단축, 38개 AI 전략 전원 심사 통과 등의 성과를 만들었습니다.',
    ...
    careers: [
      ...
      {
        company: '에셋플러스자산운용(주)',
        meta: 'AI자산운용팀 | 사원 | 2023.09 ~ 2025.03 (2023.11~ 알파브릿지 겸임·상주)',
        blocks: [
          {
  ...
  wanted: {
    ...
    extraSections: [
      {
        // 원티드 "AI 활용 경험"은 항목당 50자 상한. 개수 제한은 없으므로 잘게 나눈다.
        label: 'AI 활용 경험',
        maxPerBullet: 50,
        bullets: [
          '프론트 개발자 0명 팀에서 AI 코딩 도구로 화면 직접 구현',
          'Claude Code로 약 500개 전략 분석 플랫폼 화면 구현',
          '기획서 대신 동작하는 화면으로 요건 합의',
          'AI 도구로 지표 산식 전수조사, 중복·발산 지점 탐지',
          '10개 핵심 지표를 표준화해 전사 분석 기준 통일',
          '디자인 시안을 실제 데이터 구조와 대조해 검증',
          'AI가 자동 조합한 전략의 변경 이력으로 사후 검증',
          'AI 멀티에이전트 주식 분석 서비스 주주곰 1인 기획·개발',
          '금융 분석 관점별 6개 전문 에이전트 파이프라인 설계',
          '4인 페르소나 토론으로 종합 판단하는 구조 설계',
          '판단 근거를 단계적으로 공개하는 정보 구조 구현',
          '실사용자 관찰 후 하루 단위로 피드백 반영·개선',
        ],
      },
    ],
    skills: [
